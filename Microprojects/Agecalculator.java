...
public class Agecalculator
  {
    public static void main(String[] args)
    {
      ...
      if(current_day<=20 && current_month<=11 && current_year>birth_year)   
      {
       int current_age = (current_year-birth_year);
        System.out.println( name + " present age is "+ "("+ current_day +"-"+ 
       current_month +"-"+current_year +")" + current_age);
        System.out.println( name + " birth age is "+ "("+ birth_day +"-"+ 
